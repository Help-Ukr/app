...
export const COLLECTION_POINTS: CollectionPoint[] = [
  {
    ...
    availableItems: [
      { itemCategoryId: "1", quantity: 12 },
      { itemCategoryId: "2", quantity: 5 },
      { itemCategoryId: "4", quantity: 7 },
      { itemCategoryId: "5", quantity: 10 },
    ],
    neededItems: [
      { itemCategoryId: "3" },
      { itemCategoryId: "6" },
  ...
  },
  {
    ...
    coverImg:
      "https://lh3.ggpht.com/p/AF1QipMXQXw-I8s_Y2oR1b9d2B-eGi0u7HkYcK4fZmv9=s1024",
  },
  {
    displayName: "Wohnzimmerbar",
    availableItems: [
      { itemCategoryId: "3", quantity: 5 },
      { itemCategoryId: "6", quantity: 122 },
      { itemCategoryId: "4", quantity: 190 },
      { itemCategoryId: "5", quantity: 19 },
    ],
    neededItems: [
      { itemCategoryId: "1" },
      { itemCategoryId: "2" },
    ...
    coverImg:
      "https://lh3.ggpht.com/p/AF1QipOwDYTnfLd27TGBYCzqmsB297frwy0wOfgXDwUP=s512",
  },
  {
    ...
    coverImg:
      "https://lh3.ggpht.com/p/AF1QipOyNGjrHs6mKvJDMFmYpI-4A2UcRW7gHfwaYlKr=s512",
  },
  {
    ...
    coverImg:
      "https://lh5.googleusercontent.com/p/AF1QipOzrJCt7ayS8QXS8l3TFE1j_m34L1jt_Hos1PuI=s451-k-no",
  },
];
