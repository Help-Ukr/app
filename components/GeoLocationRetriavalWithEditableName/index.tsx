...
const GeoLocationRetriavalWithEditableName = ({
  location,
  onChange,
  withName = true,
}: Props) => {
  const [status, setStatus] = useState<"show_map" | "show_form">(
    location ? "show_form" : "show_map"
  );
